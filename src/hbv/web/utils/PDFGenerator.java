...
public class PDFGenerator {
    ...
    public static ByteArrayOutputStream generatePdf(
     int buchungId,String vorname, String nachname,
                ...
                String date,String time, ByteArrayOutputStream qrCodeData){
        ...
        try {
            ...
            document.add(new Paragraph("Mit freundlichen Grüßen,\nIhr Impfzentrum-Team", italicFont));
               ...
               // Trennlinie vor dem QR-Code
     document.add(Chunk.NEWLINE);
     document.add(new LineSeparator());
     document.add(Chunk.NEWLINE);

     // Überschrift für den QR-Code
     Paragraph qrTitle = new Paragraph(
        "QR-Code für den Impftermin",
        sectionFont);
...
// QR-Code aus den PNG-Daten erstellen
       Image qrCodeImage = Image.getInstance(
        qrCodeData.toByteArray());

// Größe des QR-Codes in der PDF
       qrCodeImage.scaleToFit(180, 180);
