...
import hbv.web.utils.EmailService;
            ...
            HttpSession oldSession = request.getSession(false);
             ...
             HttpSession session = request.getSession(true);
               ...
               //EmailService.sendEmail(email, "Bestätigung der Registrierung",
                ...
                //bis hier
String emailBody = "Hallo " + firstname + " " + lastname + "!\n\n" +
                   "Ihr Konto wurde erfolgreich erstellt. Jetzt können Sie sich mit Ihrer E-Mail und Ihrem Passwort einloggen.\n\n" +
                   "Klicken Sie hier, um sich einzuloggen: " +
                   "https://informatik.hs-bremerhaven.de/docker-swe3-2023-08-java/user_login.html\n\n" +
                   "Mit freundlichen Grüßen,\nIhr Team";

              EmailService.sendEmail(email, "Bestätigung der Registrierung", emailBody);
